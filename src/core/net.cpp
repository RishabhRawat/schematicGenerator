...
net::net(const std::string& netName, const int netWidth)
	: netIdentifier(netName), netWidth(netWidth), highIndex(netWidth - 1), lowIndex(0), highToLow(true) {
